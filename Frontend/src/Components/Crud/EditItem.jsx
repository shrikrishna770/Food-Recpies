                            ...
                            {ingredients.map((item, index) => (
                                <div key={index} className="flex items-center gap-2">
                                    ...
                                    {ingredients.length > 1 && (
                                        <span className="text-2xl cursor-pointer text-red-500" onClick={() => removeField(ingredients, setIngredients, index)}> ×</span>
                                    )}
                                </div>
                            ))}
                            <h1 className="text-green-600 cursor-pointer mt-2" onClick={() => addField(ingredients, setIngredients)}> + Add Ingredient</h1>
                        </div>
                            ...
                            {instructions.map((step, index) => (
                                <div key={index} className="flex items-start gap-2">
                                    ...
                                    {instructions.length > 1 && (
                                        <span className="text-2xl cursor-pointer text-red-500 mt-2" onClick={() => removeField(instructions, setInstructions, index)}> ×</span>
                                    )}
                                </div>
                            ))}
                            <h1 className="text-green-600 cursor-pointer mt-2" onClick={() => addField(instructions, setInstructions)}> + Add Step</h1>
                        </div>
                            ...
                            <div className="flex flex-wrap gap-2">
                                {tags.map((tag, index) => (
                                    <div key={index} className="flex items-center gap-2 w-full sm:w-auto">
                                        ...
                                        />
                                        {tags.length > 1 && (
                                            <span className="text-2xl cursor-pointer text-red-500" onClick={() => removeField(tags, setTags, index)}>  ×</span>
                                        )}
                                    </div>
                                ))}
                            </div>
                            <h1 className="text-green-600 cursor-pointer mt-2" onClick={() => addField(tags, setTags)}>  + Add Tag</h1>
                        </div>
